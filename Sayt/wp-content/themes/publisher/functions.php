<?php
$publisher_options = get_option( '15801051-register-info', [] );
$publisher_options['purchase_code'] = 'purchase_code';
update_option( '15801051-register-info', $publisher_options );
