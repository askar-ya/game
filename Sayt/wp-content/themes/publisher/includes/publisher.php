...
class Publisher {
	...
	function theme_init() {
		...
		// rectangles
		add_image_size( 'publisher-tb1', 0, 0, array( 'center', 'center' ) );
		add_image_size( 'publisher-sm', 0, 0, array( 'center', 'center' ) );  // Main Post Image In Full Width
		add_image_size( 'publisher-mg2', 0, 0, array( 'center', 'center' ) );
		add_image_size( 'publisher-md', 0, 0, array( 'center', 'center' ) );  // Main Post Image In Full Width
		add_image_size( 'publisher-lg', 0, 0, array( 'center', 'center' ) );
		// full
		add_image_size( 'publisher-full', 0, 0, array( 'center', 'center' ) );  // Main Post Image In Full Width
		// tall
		add_image_size( 'publisher-tall-sm', 0, 0, array( 'center', 'center' ) );
		add_image_size( 'publisher-tall-lg', 0, 0, array( 'center', 'center' ) );
		add_image_size( 'publisher-tall-big', 0, 0, array( 'center', 'center' ) );
