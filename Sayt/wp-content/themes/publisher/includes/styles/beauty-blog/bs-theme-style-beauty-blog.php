...
/**
 * Publisher -> Beauty Blog
 */
class Publisher_Theme_Style_Beauty_Blog extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/beauty-blog/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/beauty-blog/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-beauty-blog',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'beauty-blog/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'beauty-blog/style' ), '.css' ),
			Better_Framework()->theme()->get( 'Version' ) . mt_rand(100,10000000)
		);
	}
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-beauty-blog' );
	}
...
} // Publisher_Theme_Style_Beauty_Blog
