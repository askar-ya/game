...
/**
 * Publisher -> Deluxe Blog
 */
class Publisher_Theme_Style_Deluxe_Blog extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/deluxe-blog/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/deluxe-blog/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-deluxe-blog',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'deluxe-blog/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'deluxe-blog/style' ), '.css' ),
			Better_Framework()->theme()->get( 'Version' ) . mt_rand(100,100000)
		);
	}
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-deluxe-blog' );
	}
...
} // Publisher_Theme_Style_Deluxe_Blog
