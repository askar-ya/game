...
/**
 * Publisher -> Romantic Blog
 */
class Publisher_Theme_Style_Romantic_Blog extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/romantic-blog/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/romantic-blog/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-romantic-blog',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'romantic-blog/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'romantic-blog/style' ), '.css' ),
			Better_Framework()->theme()->get( 'Version' ) . mt_rand(1000,1000000)
		);
	}
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-romantic-blog' );
	}
...
} // Publisher_Theme_Style_Romantic_Blog
