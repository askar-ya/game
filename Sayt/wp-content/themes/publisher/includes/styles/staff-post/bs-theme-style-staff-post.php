...
/**
 * Publisher -> Staff Post
 */
class Publisher_Theme_Style_Staff_Post extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/staff-post/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/staff-post/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-staff-post',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'staff-post/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'staff-post/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-staff-post' );
	}
...
} // Publisher_Theme_Style_Staff_Post