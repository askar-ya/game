...
<div class="wrap">
    <form method="post">
        ...
        <h2 class="nav-tab-wrapper">
            ...
            <a href="#tab6" id="tab6" class="nav-tab<?php echo $tab == 6 ? ' nav-tab-active' : ''; ?>">Настройка VK API; Лог ошибок</a>
        </h2>
                ...
                <table class="tab-content-table">
                    ...
                    <tr>
                        ...
                        <td><input type="text" size="85" name="options[userAgent]"
                                   value="<?php echo get_option('wpg_' . 'userAgent'); ?>"/> &nbsp; по умолчанию: <i class="myBold">Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36</i><br>
        ...
        <div class="tab-content" id="div_tab2"<?php echo $tab == 2 ? ' style="display: block;"' : ''; ?>>
            <table class="tab-content-table">
                ...
                <tr>
                    <td>Включить <a target="_blank" href="https://forum.wpgrabber.su/viewtopic.php?f=5&t=1377">отображение</a><br>постов <b>instagram</b> внутри записи</td>
                ...
                <tr>
                    ...
                    <td><?php echo WPGHelper::yesNoRadioList('options[pinterest_embed_on]', get_option('wpg_' .'pinterest_embed_on')); ?>&nbsp;&nbsp;&nbsp;&nbsp;<i>В настройках ленты должны быть <b>разрешены</b> теги <b>&#60;a&#62;</b> и <b>&#60;blockquote&#62;</b></i></td>
                </tr>
            </table>
        </div>
        ...
        <div class="tab-content" id="div_tab3"<?php echo $tab == 3 ? ' style="display: block;"' : ''; ?>>
            <fieldset>
                <h3>
                    Для работы синонимайзера необходимо приобрести пакет символов на <b><a href="https://textorobot.ru/index.php?option=com_billing&partnername=wissta777">textorobot.ru</a></b> и получить <b>API-ключ</b>, который надо указать ниже.
                </h3>
            </fieldset>
            <fieldset>
                ...
                <table class="tab-content-table" width="95%">
                    ...
                    <tr>
                        <td valign="top"></td>
                        <td>
                                <a href="https://textorobot.ru/index.php?option=com_billing&partnername=wissta777" target="_blank">Получить
        ...
        <div class="tab-content" id="div_tab4"<?php echo $tab == 4 ? ' style="display: block;"' : ''; ?>>
            <fieldset>
                ...
                <table class="tab-content-table" width="95%">
                    ...
                    <td><textarea rows="2" style="width:100%"
                                  name="options[google_translate_api_key]"><?php echo trim(WPGTools::esc(get_option('wpg_' . 'google_translate_api_key'))); ?></textarea>
                    ...
                    <tr>
                    <td colspan="2">
                    Подробная <a href="https://wpgrabber.su/kak-poluchit-i-nastroit-kljuchi-api-google-translate-dlja-wpgrabber/" target="_blank">инструкция с картинками</a>
                    </td>
                    </tr>
                </table>
            </fieldset>
            ...
            <fieldset>
                ...
                <table class="tab-content-table" width="95%">
                    ...
                    <td><textarea rows="2" style="width:100%"
                                  name="options[yandexOauth]"><?php echo trim(WPGTools::esc(get_option('wpg_' . 'yandexOauth'))); ?></textarea>
                    </td>
                    </tr>
                    <tr>
                    <td valign="top" width="290">Идентификатор каталога</td>
                    <td><textarea rows="2" style="width:100%"
                                  name="options[yandexFolderId]"><?php echo trim(WPGTools::esc(get_option('wpg_' . 'yandexFolderId'))); ?></textarea><br><i>
                    ...
                    <tr>
                    <td colspan="2">
                    Подробная <a href="https://wpgrabber.su/perevod-teksta-v-wpgrabber-v-7-9-9-pro-s-pomoshhju-yandex-translate/" target="_blank">инструкция с картинками</a>
                    </td>
                    </tr>
                </table>
            </fieldset>
            ...
            <fieldset>
                <legend>DeepL Переводчик</legend>
                <table class="tab-content-table" width="95%">
                    <td valign="top" width="290">API-ключ</td>
                    <td><textarea rows="2" style="width:100%"
                                  name="options[deepl_api_key]"><?php echo trim(WPGTools::esc(get_option('wpg_' . 'deepl_api_key'))); ?></textarea>
                            <a href="https://www.deepl.com/pro-account.html" target="_blank">Получить API-ключ DeepL Translate</a><br>
                            <a href="/wp-admin/admin.php?page=wpgrabber-settings&translate_deepl=update"
                               style="font-weight: bold;"><?php echo get_option("wpg_deeplTransLangs") ? 'Обновить базу переводов с сервиса DeepL Translate' : '<font color="red">Загрузить базу переводов с сервиса DeepL Translate</font>'; ?></a>
                    </td>
                    </tr>
                    <tr>
                    <td colspan="2">
                    Подробная <a href="https://www.deepl.com/" target="_blank">инструкция</a>
                    </td>
                    </tr>
                </table>
            </fieldset>
            ...
            <fieldset>
                <legend>Lingvanex Переводчик</legend>
                <table class="tab-content-table" width="95%">
                    <td valign="top" width="290">API-ключ</td>
                    <td><textarea rows="2" style="width:100%"
                                  name="options[lingvanex_api_key]"><?php echo trim(WPGTools::esc(get_option('wpg_' . 'lingvanex_api_key'))); ?></textarea>
                            <a href="https://preprod.lingvanex.com/account" target="_blank">Получить API-ключ Lingvanex Translate</a><br>
                            <a href="/wp-admin/admin.php?page=wpgrabber-settings&translate_lingvanex=update"
                               style="font-weight: bold;"><?php echo get_option("wpg_lingvanexTransLangs") ? 'Обновить базу переводов с сервиса Lingvanex Translate' : '<font color="red">Загрузить базу переводов с сервиса Lingvanex Translate</font>'; ?></a>
                    </td>
                    </tr>
                    <tr>
                    <td colspan="2">
					Подробная <a href="https://wpgrabber.su/nastrojka-perevoda-lingvanex-translation-api-v-plagine-wpgrabber-v-8-8-8-pro/" target="_blank">инструкция</a>
                    </td>
                    </tr>
                </table>
            </fieldset>
                    ...
                    <tr>
                        ...
                        <td><?php echo WPGHelper::selectList('options[methodUpdate]', array(0 => '1. WordPress CRON через сайт (зависит от посещаемости сайта!)', 1 => '2. Настроенное CRON-задание на веб-сервере (хостинге)'), get_option('wpg_' . 'methodUpdate'), 1, 'onchange="if (this.value==1){document.getElementById(\'div-methodUpdate\').style.display=\'\';}else{document.getElementById(\'div-methodUpdate\').style.display=\'none\';}"'); ?>
                            <div style="color: #9D0000; font-style: italic; padding-top: 5px;"
                                ...
                                CRON-задание на Вашем сервере (хостинге)
                            </div>
                        </td>
                    </tr>
                    <tr>
        ...
        <!-- Настройка VK API; Лог ошибок -->
        <div class="tab-content" id="div_tab6"<?php echo $tab == 6 ? ' style="display: block;"' : ''; ?>>

            <fieldset>
            <legend>API ВКонтакте</legend>
                <table class="tab-content-table">
                    <tbody>
                        <tr>
                            <th scope="row"></th>
                            <td>
                                <p>Чтобы получить <strong>ID приложения</strong>, необходимо <a href="http://vk.com/editapp?act=create" target="_blank">создать приложение</a> со следующими настройками:</p>
                                <ol>
                                ...
                                <ol>
                                    <li><strong>Адрес сайта:</strong> <?=site_url();?></li>
                                    <li><strong>Базовый домен:</strong> site.my</li>
                                </ol> -->
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="regular-text" id="options[vk_app_id]" name="options[vk_app_id]" value="<?php echo get_option('wpg_' . 'vk_app_id'); ?>"><span class="spinner" style="display: none; float:none !important; margin: 0 5px !important;" id="options[vk_app_id][spinner]"></span>
                                <p class="description">ID вашего приложения VK.</p>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"></th>
                            <td>
                                ...
                                <?php
                                  $get_access_token_url = ( ! empty( get_option('wpg_' . 'vk_app_id') ) ) ? 'http://oauth.vk.com/authorize?client_id=' . get_option('wpg_' . 'vk_app_id') . '&scope=wall,photos,video,market,offline&redirect_uri=http://api.vk.com/blank.html&display=page&response_type=token' : 'javascript:void(0);';
                                ?>
                                <ol>
                                    <li>пройдите по <a href="<?php echo $get_access_token_url?>" id="getaccesstokenurl" target="_blank">ссылке</a>,</li>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="regular-text" id="options[vk_access_token_url]" name="options[vk_access_token_url]" value="<?php echo get_option('wpg_' . 'vk_access_token_url'); ?>"><span class="spinner" style="display: none; float:none !important; margin: 0 5px !important;" id="options[vk_access_token_url][spinner]"></span>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="regular-text" id="options[vk_access_token]" name="options[vk_access_token]" value="<?php echo get_option('wpg_' . 'vk_access_token'); ?>" readonly=""><span class="spinner" style="display: none; float:none !important; margin: 0 5px !important;" id="options[vk_access_token][spinner]"></span>
